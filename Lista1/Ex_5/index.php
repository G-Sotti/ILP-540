    ...
    <form method="post" action="resposta.php">
        <div class="row">
            <div class="col-3">
                ...
                <input type="double" name="nt1"
                id="nt1" class="form-control"/>
            </div>
        </div>
        <div class="row">
        <div class="col-3">
                ...
                <input type="double" name="nt2"
                id="nt2" class="form-control"/>
            </div>
        </div>
        <div class="row">
            <div class="col-3">
                ...
                <input type="double" name="nt3"
                id="nt3" class="form-control"/>
            </div>
        </div>
        <div class="row">
            <div class="col-3">
                ...
                <input type="double" name="nt4"
                id="nt4" class="form-control"/>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col">
